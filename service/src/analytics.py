...
# Promotion readiness moved to src/readiness.py (SPEC-readiness-criteria.md) —
# step_specs() replaces _confidence_thresholds_by_step, gather_readiness_evidence()
# + evaluate_readiness() replace get_pipeline_promotion_readiness(). readiness.py
# is config-driven policy evaluation, a different concern from the stats rollups
# in this module.
